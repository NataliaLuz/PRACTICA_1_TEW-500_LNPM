<?php
//16 POO, CREAR UNA CLASE ESTUDIANTE, PARA LOS ATRIBUTOS USAR METODOS GET Y SET, CREAR METODO MOSTRARs
...
echo "<b>Usar metodos GET y SET, crear metodo mostrar.</b><br>";
?>
<?php
class Estudiante
{
