...
echo "<b>Promedio de Notas de un Estudiante.</b><br>";
?>
...
<body>
    <header>
        ...
        <img src="IMG-20220928-WA0000.jpg" width="700" height="400" />
        <br>
    </header>
    <section>
        <?php
    ...
    <footer>
       <h3 id="centrado">Todos los derechos reservados - By LUZ :) </h3>
    </footer>
</body>
